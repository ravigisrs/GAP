...
var lyr_dst_4 = new ol.layer.Vector({
                ...
                style: style_dst_4,
                interactive: true,
                title: '<img src="styles/legend/dst_4.png" /> dst'
            });
...
var lyr_Water_Sample_Points_6 = new ol.layer.Vector({
                ...
                interactive: true,
                title: '<img src="styles/legend/Water_Sample_Points_6.png" /> Water_Sample_Points'
            });
...
var lyr_BMW_Sites_7 = new ol.layer.Vector({
                ...
                interactive: true,
                title: '<img src="styles/legend/BMW_Sites_7.png" /> BMW_Sites'
            });
...
var layer = new ol.layer.Group({
    title: 'Layers',
    layers: [lyr_dst_4, lyr_River_5, lyr_Water_Sample_Points_6, lyr_BMW_Sites_7, lyr_CETP_8, lyr_STP_9]
});
lyr_dst_4.setVisible(true);lyr_River_5.setVisible(true);lyr_Water_Sample_Points_6.setVisible(true);lyr_BMW_Sites_7.setVisible(true);lyr_CETP_8.setVisible(true);lyr_STP_9.setVisible(true);
var layersList = [lyr_dst_4,lyr_River_5,lyr_Water_Sample_Points_6,lyr_BMW_Sites_7,lyr_CETP_8,lyr_STP_9];
...
lyr_Water_Sample_Points_6.set('fieldImages', {'Name': '', 'RegionName': '', });
lyr_BMW_Sites_7.set('fieldImages', {});
lyr_CETP_8.set('fieldImages', {});
lyr_STP_9.set('fieldImages', {'Sr__No': '', 'Region': '', 'District': '', 'STP_Name': '', 'Town__City': '', 'Deptt_': '', 'Capacity__': '', 'Ultimate_d': '', 'Latitude': '', 'Longitude': '', 'Date_of_Co': '', 'Status': '', 'Mobile_No_': '', 'Methane_cp': '', 'Dual_pipin': '', 'Online_Dev': '', 'Consent_St': '', 'Technology': '', 'Upgradatio': '', 'Installati': '', 'Installa_1': '', 'CTO_Y_N': '', 'effluent_r': '', 'BOD': '', 'COD': '', 'PH': '', 'TSS': '', 'Oil___Grea': '', 'Remarks': '', 'Report_No_': '', 'Compliance': '', });
